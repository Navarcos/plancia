...
// @Router /namespaces/{skafosNamespace}/skafos/{skafosName}/statefulSet [get]
func HandleListStatefulSets(registry client.SkafosRegistry) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		...
		list, err := resource.ListStatefulSets(request.Context(), registry, param)
		if err != nil {
...
// @Failure 500 {object} dtos.ProblemDetails
// @Router /namespaces/{skafosNamespace}/skafos/{skafosName}/namespaces/{resourceNamespace}/statefulSet/{resourceName} [get]
func HandleGetStatefulSet(registry client.SkafosRegistry) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		param := apiParams(request)
		result, err := resource.GetStatefulSet(request.Context(), registry, param)
		if err != nil {
			setErrorInRequestContext(request, err)
			return
		}
...
// HandleDeleteStatefulSet
// @Summary delete skafos statefulSet
// @ID delete-skafos-statefulSet
// @Tags StatefulSets
// @Produce application/json
// @Param skafosNamespace path string true "skafos namespace"
// @Param skafosName path string true "skafos name"
...
// @Failure 404 {object} dtos.ProblemDetails
// @Failure 500 {object} dtos.ProblemDetails
// @Router /namespaces/{skafosNamespace}/skafos/{skafosName}/namespaces/{resourceNamespace}/statefulSets/{resourceName} [delete]
func HandleDeleteStatefulSet(registry client.SkafosRegistry) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		param := apiParams(request)
		err := resource.DeleteStatefulSet(request.Context(), registry, param)
		if err != nil {
			setErrorInRequestContext(request, err)
			return
		}
